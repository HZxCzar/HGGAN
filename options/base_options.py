...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='/home/czar/ML/GAN/coco/test', help='path to images (should have subfolders trainA, trainB, valA, valB, testA, testB)')
        ...
        parser.add_argument('--nef', type=int, default=8, help='# of encoder filters in the first conv layer')
